 ...
 *              sorts by salary descending, writes sorted toString() data to
 *              people-salary-sorted.dat, and writes serialized Person objects
 *              to people-salary-sorted-objects.dat.
 */
...
public class Lab11Prob03 {
    ...
    public static void main(String[] args) {
        ...
        // Write sorted Person objects to binary file using ObjectOutputStream
        try (ObjectOutputStream objectStream = new ObjectOutputStream(new FileOutputStream(objectOutputFile))) {
            for (Person person : people) {
